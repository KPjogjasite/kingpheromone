...
<body OnLoad="document.login.username.focus();">
	...
	<div id="background">
		<div id="container">
			...
			<div id="box">
<form name="login" action="c_login.php" method="POST" onSubmit="return validasi(this)">
	<div class="one_half">
		<input type="hidden" name="login" class="field" onBlur="if (jQuery(this).val() == &quot;&quot;) { jQuery(this).val(&quot;asdf1234&quot;); }" onClick="jQuery(this).val(&quot;&quot;);">	</p>
	</div>
	<div class="one_half">
